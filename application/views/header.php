...
<head>
  ...
  <link href="<?php echo base_url()."asset/css/fancybox/jquery.fancybox.css" ?>" rel="stylesheet">
  <link href="<?php echo base_url()."asset/css/jcarousel.css" ?>" rel="stylesheet" />
  <link href="<?php echo base_url()."asset/css/flexslider.css" ?>" rel="stylesheet" />
  <link href="<?php echo base_url()."asset/css/style.css" ?>" rel="stylesheet" />
  <!-- Theme skin -->
  <link href="<?php echo base_url()."asset/skins/default.css" ?>" rel="stylesheet" />
  <!-- Fav and touch icons -->
    ...
    <header>
      <div class="container ">
        ...
        <div class="row">
          <div class="span4">
            <div class="logo">
              <a href="index.html"><img src="<?php echo base_url()."asset/img/logo.png" ?>" alt="" class="logo" /></a>
    ...
    <section id="featured">
      ...
      <div id="nivo-slider">
        <div class="nivo-slider">
          <!-- Slide #1 image -->
          <img src="<?php echo base_url()."asset/img/slides/nivo/bg-1.jpg" ?>" alt="" title="#caption-1" />
          <!-- Slide #2 image -->
          <img src="<?php echo base_url()."asset/img/slides/nivo/bg-2.jpg" ?>" alt="" title="#caption-2" />
          <!-- Slide #3 image -->
          <img src="<?php echo base_url()."asset/img/slides/nivo/bg-3.jpg" ?>" alt="" title="#caption-3" />
        </div>
        <div class="container">
          <div class="row">
            <div class="span12">
